        ...
        <div className="flex flex-col justify-evenly items-center gap-5 lg:flex-row lg:items-start lg:gap-16">
          <div className="relative w-full max-w-md  ">
            <div className="relative aspect-square">
              <div className="absolute inset-0 bg-gradient-to-br from-teal-100 via-orange-50 to-rose-100 rounded-full opacity-20" />
              <img
                src={AboutUsImage}
          ...
          <div className="flex flex-col items-center md:items-start lg:w-1/2">
            ...
            <p className="mb-8 font-bold pr-12 text-center md:text-start leading-tight text-gray-700">
